...
- **Samsung AI Center** - курс "Нейронные сети и компьютерное зрение" (2025)
- **Карпов Курс** - "Статистика" и "Введение в Data Science и машинное обучение"
...
Выиграл во Всероссийской олимпиаде по строительству и прошел путь от инженера-конструктора до главного инженера проекта ЖК «Сердце Столицы». Для автоматизации инженерных задач и процессов углубился в Data Science и машинное обучение. Ищу амбициозную команду для активного развития в прикладных ML-задачах.
...
Позицию Junior Data Scientist / ML Engineer в команде, которая решает прикладные ML-задачи в production. Интересуют: NLP, Computer Vision, RAG системы, временные ряды, классификация и детекция объектов.
